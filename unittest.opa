...
function run_tests() {
  ...
  t = expect_clean_lint(t, "character class", "[.-]")
  t = expect_clean_lint(t, "\\[ in character class", "[\\[]")
  t = expect_clean_lint(t, "\\] in character class", "[\\]]")
  t = expect_clean_lint(t, "\\\\ in character class", "[\\\\]")
  t = expect_clean_lint(t, "\\[-x in character range", "[\\[-x]")
  ...
  t = expect_lint_error(t, "character class", "[\\d]", {non_optimal_class_range})
  t = expect_lint_error(t, "character class", "[\\d5]", {non_optimal_class_range})
