...
expect_lint_error("overlapping ranges", "[a-mb-z]", 8)
expect_lint_error("included ranges", "[a-md-g]", 8)
expect_lint_error("character from range", "[a-zx]", 8)
expect_lint_error("complex overlapping", "[fg-ia-ec-j]", 8)
expect_lint_error("complex inclusion", "[fg-ia-ec-h]", 8)
